		...
		{
			{
				value_min = 96,
				value_max = 97,
				load_entity = "mods/dextrome_summon_spells/data/entities/items/pickup/egg_support.xml",
				offset_y = -2,
			},
			{
				value_min = 94,
				value_max = 95,
				load_entity = "mods/dextrome_summon_spells/data/entities/items/pickup/egg_tappura.xml",
				offset_y = -2,
			},
			{
				value_min = 92,
				value_max = 93,
				load_entity = "mods/dextrome_summon_spells/data/entities/items/pickup/egg_frog.xml",
				offset_y = -2,
			},
			{
				value_min = 90,
